...
namespace JuliePro_DataAccess.Data
{
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<CalendarEvent>().HasData(new CalendarEvent() { Id = 1, Description = "Niveau Bronze", Date = new DateTime(2022, 11, 20, 00, 00, 00), Category_Id = 2 });
            ...
            builder.Entity<CalendarEvent>().HasData(new CalendarEvent() { Id = 4, Description = "Trialthon", Date = new DateTime(2022, 09, 08, 00, 00, 00), Category_Id = 1 });
            builder.Entity<CalendarEvent>().HasData(new CalendarEvent() { Id = 5, Description = "Niveau Argent", Date = new DateTime(2022, 08, 26, 00, 00, 00), Category_Id = 2 });
            #endregion
